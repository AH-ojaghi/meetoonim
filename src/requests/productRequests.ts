...
import {ProductCreateCredentials, ProductUpdateCredentials} from "../redux/dashboard/products/productsAction";

class ProductRequests {

    public static async getAllProducts(): Promise<AxiosResponse> {
        // const userType = checkUser();
            return await API.authGet("products", {isUseLoading: true});
    }
